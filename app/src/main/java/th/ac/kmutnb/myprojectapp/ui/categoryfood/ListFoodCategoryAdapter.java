...
public class ListFoodCategoryAdapter extends RecyclerView.Adapter<ListFoodCategoryAdapter.ViewHolder>{
    ...
    public ListFoodCategoryAdapter(List<ItemModel> listitems){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_categorylistfood, parent, false);
