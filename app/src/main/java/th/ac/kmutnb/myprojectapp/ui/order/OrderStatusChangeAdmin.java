...
public class OrderStatusChangeAdmin extends AppCompatActivity {
    ...
    public void CancelStatus(String ID_Order){
        ...
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (response.equals("Cancel Successfully")) {
                    ...
                    Toast.makeText(OrderStatusChangeAdmin.this, response, Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(OrderStatusChangeAdmin.this, AdminOrder.class));
                    finish();
                } else {
                    Toast.makeText(OrderStatusChangeAdmin.this, response, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(OrderStatusChangeAdmin.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
        ...
        RequestQueue queue = Volley.newRequestQueue(OrderStatusChangeAdmin.this);
        queue.add(request);
    }
