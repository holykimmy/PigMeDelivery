...
public class AdminDetail extends AppCompatActivity {
    ...
    private AdminDetailOrderListAdapter admindetailOrderListAdapter;
        ...
        JsonArrayRequest jsRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(AdminDetail.this,error.toString(),Toast.LENGTH_SHORT).show();
                        pDialog.hide();
                    }
                });  // Request

        mQueue = Volley.newRequestQueue(AdminDetail.this);
    ...
    public void displayListview(){
        ...
        admindetailOrderListAdapter = new AdminDetailOrderListAdapter(listitem);
        recyclerViewListitem.setLayoutManager(new GridLayoutManager(AdminDetail.this, 1, GridLayoutManager.VERTICAL, false));
